...
<tileset version="1.10" tiledversion="1.11.2" name="Coliseu" tilewidth="32" tileheight="32" spacing="2" margin="1" tilecount="54" columns="9">
 <image source="Coliseu.png" width="306" height="204"/>
 <wangsets>
  <wangset name="GroundColiseu" type="corner" tile="-1">
